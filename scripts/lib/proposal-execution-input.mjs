...
export function buildGateInput({ proposal, currentPrice, holdings, cash, killSwitchContent, market = 'KR' }) {
  ...
  return {
    ...
    orderCost,
    alreadyExecutedIds: [], // 알려진 한계 — execute-quant-proposal.mjs 파일 상단 주석 참고
