...
const RAW_ALIASES = {
  ...
  // TIME Korea플러스배당액티브 — 오너 확인(2026-09-05): "TIMEFOLIO Korea배당액티브"
  // ("플러스" 누락)는 같은 상품의 다른 표기.
  'TIMEFOLIO Korea배당액티브': 'TIME Korea플러스배당액티브',
  // ACE 미국하이일드액티브(H) — 오너 확인(2026-09-05): "(H)"(헤지형) 표시가 없는
  // "한국투자 ACE 미국하이일드액티브증권상장지수투자신탁[채권-재"(카카오 정식
  // 장문명, 운용사 "한국투자" 접두사 포함)도 같은 헤지형 상품.
  '한국투자 ACE 미국하이일드액티브증권상장지수투자신탁[채권-재': 'ACE 미국하이일드액티브(H)',
};
