...
export const COLORS = {
  ...
  // v1 시트는 이 자산군을 "현금성"으로 불렀지만(테스트 픽스처 등 레거시 잔재),
  // v2 Vault 네이티브 보유(예수금 등)의 실제 assetClass 값은 "현금"이다 — 키가
  // 안 맞아 자산군 배지가 회색(#aaa 폴백)으로만 나오던 것 수정(오너 지적, 2026-08-22).
  현금성: "#8A93A6", 현금: "#8A93A6",
};
